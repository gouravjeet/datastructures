...
typedef  std::map<std::string,std::map<std::string,int> >  MY_MAP;//typedef
...
/* ===============================================================================================================
This helper function will work for window size 3...I have implemented it 
but it is giving the wrong output..so i commented it out
==================================================================================================================
