...
class hash_string_obj_non_trivial {
public:
...
typedef ds_hashset<std::string, hash_string_obj_non_trivial> ds_hashset_type;
...
int main() {
  ...
  //my test
  insert_result = set1.insert( std::string("ypupp") );
  assert( insert_result.second );
  ...
  //my test
  insert_result = set1.insert( std::string("dyadd") );
  assert( insert_result.second );
